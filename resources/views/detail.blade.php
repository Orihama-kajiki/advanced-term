...
<body class="detail-page">
  <div class="flex bg-gray-100 w-screen h-screen px-20 pt-10 pb-6">
    <div class="flex-1">
      <div class="grid grid-cols-1 w-full pr-10">
    ...
    <div class="flex-1 pl-10 h-full ">
      <div class="box-content border-blue-600 bg-blue-600 h-full w-full rounded-lg relative shadow-3xl">
        ...
        <form method="POST" action="{{ route('reserve.store') }}">
            ...
            <div class="resavation_detail h-8 w-full ml-5 mb-4">
            ...
            <div class="resavation_detail h-8 w-full ml-5 mb-5">
            ...
            <div class="w-4/5 ml-5 mr-8 px-3 py-5 border-blue-300 bg-blue-300 border-4 rounded-lg">

...
class ShopsTableSeeder extends Seeder
{
  public function run()
  {
    $areaId = DB::table('areas')->where('name', '東京都')->first()->id;
    $genreId = DB::table('genres')->where('name', '寿司')->first()->id;
    ...
    $areaId = DB::table('areas')->where('name', '大阪府')->first()->id;
    $genreId = DB::table('genres')->where('name', '焼肉')->first()->id;
    ...
    $areaId = DB::table('areas')->where('name', '福岡県')->first()->id;
    $genreId = DB::table('genres')->where('name', '居酒屋')->first()->id;
    ...
    $areaId = DB::table('areas')->where('name', '東京都')->first()->id;
    $genreId = DB::table('genres')->where('name', 'イタリアン')->first()->id;
    ...
    $areaId = DB::table('areas')->where('name', '福岡県')->first()->id;
    $genreId = DB::table('genres')->where('name', 'ラーメン')->first()->id;

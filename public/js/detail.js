...
var visibleElements = $(".some-class:visible");
...
$(document).ready(function () {
  ...
  $("#course_menu_id").on("change", function () {
    var selectedCourse = $(this).find("option:checked").text();
...
function setReservationValues(numOfUsers, startAt, courseMenuId) {
  ...
  var courseMenuIdInput = document.querySelector("select[name='course_menu_id']");
...
document.getElementById("reservation-form-btn").addEventListener("click", /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(event) {
    var userId, isAuthenticated, numOfUsers, selectedDate, selectedTime, startAt, courseMenuId, shopId, csrfToken, response, data;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 7:
          ...
          startAt = selectedDate + " " + selectedTime;
          courseMenuId = document.querySelector("select[name='course_menu_id']").value;
          shopId = document.querySelector("input[name='shop_id']").value;
          console.log('User ID:', userId);
          console.log('Number of Users:', numOfUsers);
          console.log('Start At:', startAt);
          console.log('Course Menu ID:', courseMenuId);
          console.log('Course Menu ID Type:', _typeof(courseMenuId));
